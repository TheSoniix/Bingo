...
/**
 * Das Interface bietet die komplette Antriebslogik für ein Bingo-Spiel (75-Kugel Variante),
 ...
 * diagonal in einer Reiher markiert wurden. Ein Unentschieden ist bei Bingo nicht möglich.
...
public interface Bingo {
     ...
     * Ein Field besteht dabei aus dem Index, dem Inhalt, einer booleschen Variable, die angibt,
     ...
     * Spielgeschehen, da dadurch die Liste in der Bingo Implementierung nicht geändert wird.
     *
     ...
     * dürfen keine Felder mehr markiert werden. Das markieren würde einen Fehler werfen.
     *
     ...
     *
     * @return ein boolescher Wert. Bei "true" ist der erste Spieler der Sieger. Bei "false" ist der
     * zweite Spieler der Sieger.
     */
     ...
     *
     * @return eine boolescher Wert. Bei "true" ist das Spiel vorbei, bei "false" noch nicht.
     */
    boolean isGameOver();
